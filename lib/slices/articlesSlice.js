...
/*
* Call this function to fetch articles from the above api.
...
const mapArticles = article => ({...article, id: getUniqueId()})

export const loadingStateSelector = state => state.articles.loading
